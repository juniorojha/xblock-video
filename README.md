...
pip install --process-dependency-links -e "git+https://github.com/appsembler/xblock-video.git@dev#egg=vimeo_xblock"
```
...
1. Check for the *Advanced Module List* policy key, and add
   `"vimeo_xblock"` in the policy value list.
...
See [workbench docs](/vimeo_xblock/workbench/README.md) for details.
