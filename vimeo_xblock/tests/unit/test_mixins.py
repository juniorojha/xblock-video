...
from vimeo_xblock.constants import DEFAULT_LANG, TPMApiLanguage, Status
from vimeo_xblock.tests.unit.base import VideoXBlockTestBase
from vimeo_xblock.tests.unit.mocks.base import ResponseStub
from vimeo_xblock.tests.unit.test_vimeo_xblock_handlers import arrange_request_mock
from vimeo_xblock.utils import loader, Transcript, ugettext as _
from vimeo_xblock.vimeo_xblock import VideoXBlock


class ContentStoreMixinTest(VideoXBlockTestBase):
    """Test ContentStoreMixin"""

    @patch('vimeo_xblock.mixins.import_from')
...
class SettingsMixinTests(VideoXBlockTestBase):
    ...
    def test_settings_property_no_vimeo_xblock_conf(self):
        """
...
class TranscriptsMixinTests(VideoXBlockTestBase):  # pylint: disable=test-inherits-tests
    ...
    @patch('vimeo_xblock.mixins.WebVTTWriter.write')
    @patch('vimeo_xblock.mixins.detect_format')
    ...
    @patch('vimeo_xblock.mixins.requests.get')
    ...
    @patch('vimeo_xblock.mixins.requests', new_callable=MagicMock)
