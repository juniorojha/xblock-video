...
from vimeo_xblock import VideoXBlock
from vimeo_xblock.tests.unit.base import VideoXBlockTestBase, arrange_request_mock
...
class UploadDefaultTranscriptHandlerTests(VideoXBlockTestBase):
    ...
    @patch('vimeo_xblock.vimeo_xblock.create_reference_name')
