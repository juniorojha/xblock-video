"""
Test cases for vimeo_xblock backends.
"""
import unittest
...
from vimeo_xblock.backends import (
    base,
    brightcove,
    html5,
    wistia,
...
from vimeo_xblock.constants import TranscriptSource
from vimeo_xblock.exceptions import VideoXBlockException
from vimeo_xblock.settings import ALL_LANGUAGES
from vimeo_xblock.tests.unit.base import VideoXBlockTestBase
from vimeo_xblock.tests.unit.mocks import (
    brightcove as brightcove_mock,
    vimeo as vimeo_mock,
    wistia as wistia_mock,
    youtube as youtube_mock,
)
from vimeo_xblock.tests.unit.mocks.base import ResponseStub
from vimeo_xblock.utils import ugettext as _
...
class VimeoApiClientTest(VideoXBlockTestBase):
    ...
    @patch('vimeo_xblock.backends.vimeo.requests.get')
    ...
    @patch('vimeo_xblock.backends.vimeo.VimeoPlayer.get_transcript_language_parameters')
    ...
    @patch('vimeo_xblock.backends.vimeo.remove_escaping')
    @patch('vimeo_xblock.backends.vimeo.requests.get')
...
class WistiaPlayerTest(VideoXBlockTestBase):
    ...
    @patch('vimeo_xblock.backends.wistia.babelfish.Language')
    @patch('vimeo_xblock.backends.wistia.requests.get')
...
class BrightcovePlayerTest(VideoXBlockTestBase):
    ...
    @patch('vimeo_xblock.backends.brightcove.requests.get')
    ...
    @patch('vimeo_xblock.backends.brightcove.BrightcoveApiClient.create_credentials')
