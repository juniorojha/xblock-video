...
from vimeo_xblock import VideoXBlock, __version__
from vimeo_xblock.constants import PlayerName
...
class VideoXBlockTests(VideoXBlockTestBase):
    ...
    @patch('vimeo_xblock.vimeo_xblock.render_resource')
    ...
    @patch('vimeo_xblock.vimeo_xblock.render_resource')
    @patch('vimeo_xblock.vimeo_xblock.resource_string')
    @patch.object(VideoXBlock, 'route_transcripts')
    ...
    @patch('vimeo_xblock.vimeo_xblock.ALL_LANGUAGES', new_callable=MagicMock)
    @patch('vimeo_xblock.vimeo_xblock.render_template')
    @patch.object(VideoXBlock, 'route_transcripts')
    ...
    @patch('vimeo_xblock.vimeo_xblock.normalize_transcripts')
